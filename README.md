# Description
This is a java monorepo with a ☕️ Massive online open courses📚 web application, backoffice to management and analyze 🧠 📊💡 and blog platform where it will public content, articles, interviews 🎙️and videos 🎥. This project it is in order to practice and learn about domain driven development (DDD) and Hexagonal ⬢ architecture 🏛️
...
## Request
```sh
$ curl --location 'http://localhost:8080/health-check'
```
...
## Request
```sh
$ curl --location --request PUT 'http://localhost:8080/courses/da5880e1-a4bf-45b8-8555-f189e0602519' \
